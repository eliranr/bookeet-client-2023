  ...
  return (
    <div dir='rtl' className='flex flex-col items-center justify-center space-y-7 h-[380px] bg-[#20b2aa]'>
        ...
        <div className='space-x-2 space-x-reverse text-xl'>
          <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-7 rounded-2xl"
            onClick={() => {
              navigate('/register');
          }}
          >
          ...
          <button className="bg-transparent hover:bg-blue-600 text-white font-semibold py-4 px-7 border border-white hover:border-transparent rounded-2xl"
            onClick={() => {
              navigate('/login');
          }}>
            התחבר
