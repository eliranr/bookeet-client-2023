    ...
    <div className='flex justify-center h-[87px] bg-[#0db9b9] px-[20px]'>
        <div className='flex items-center justify-between w-full max-w-[1050px]'>
            <div className='invisible sm:visible'>
                <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-5 rounded-full"
                    onClick={() => {
                        navigate('/register');
                    }}
                >
                ...
                <button className=" text-white font-bold py-4 px-5 rounded-full" 
                    onClick={() => {
                        navigate('/login');
                    }}
                >
